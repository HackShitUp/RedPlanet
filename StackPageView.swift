...
class StackPageView:UIView {
    ...
    func panAction(gesture:UIPanGestureRecognizer){
        ...
        if gesture.state == .began {
            if let prev = dataSource?.stackViewPrev(currentViewController: currentContainer.viewController) {
            ...
            if let next = dataSource?.stackViewNext(currentViewController: currentContainer.viewController) {
