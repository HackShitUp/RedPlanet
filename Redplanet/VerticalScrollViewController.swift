...
var doShow: Bool = false

class VerticalScrollViewController: UIViewController, UIScrollViewDelegate, SnapContainerViewControllerDelegate {
    ...
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        if scrollView.contentOffset == CGPoint(x: CGFloat(0.0), y: UIScreen.main.bounds.size.height) {
